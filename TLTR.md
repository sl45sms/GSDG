...
- write accepted samples into `${CURATION_OUT_DIR}/politics.jsonl`, `science.jsonl`, `medicine.jsonl`, `technology.jsonl`, `art.jsonl`, `history.jsonl`, `religion.jsonl`, `education.jsonl`, `philosophy.jsonl`, `sports.jsonl`, `business.jsonl`, `economics.jsonl`, `law.jsonl`, `mythology.jsonl`, `literature.jsonl`, `music.jsonl`, and `general.jsonl`,
